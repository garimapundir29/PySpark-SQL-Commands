...
# MAGIC %sql
# MAGIC SELECT * FROM f1_demo.drivers_merge TIMESTAMP AS OF '2023-11-29 06:47:30.000+0000';

# COMMAND ----------

df = spark.read.format("delta").option("timestampAsOf", '2023-11-29 06:48:32.000+0000').load("/mnt/formula1dl/demo/drivers_merge")
...
# MAGIC %sql
# MAGIC SELECT * FROM f1_demo.drivers_merge TIMESTAMP AS OF '2023-11-29 06:48:32.000+0000';
